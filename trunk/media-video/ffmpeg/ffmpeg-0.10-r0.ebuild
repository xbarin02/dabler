...
# $Header: /var/cvsroot/gentoo-x86/media-video/ffmpeg/ffmpeg-0.10.ebuild,v 1.2 2012/01/31 00:17:33 jdhore Exp $
...
src_compile() {
	...
	if use graph2dot; then
		tc-export CC
		emake tools/graph2dot
	fi
}
